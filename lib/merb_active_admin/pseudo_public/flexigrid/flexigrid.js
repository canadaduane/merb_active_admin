(function ($)
{
  $.addFlex = function (t, p)
  {
      ...
      $("tbody tr", g.bDiv).each(function ()
      {
        $(this).click(function (e)
        {
          ...
          if (!e.shiftKey) {
            ...
            if (p.onRowClick) p.onRowClick(obj)
          }
    ...
    var gtop = $(g.hDiv).height();
    $(g.block).css({ "width": g.bDiv.style.width, "height": gh, "background": "white", "position": "relative", "marginBottom": gh * -1, "zIndex": 999, "top": gtop + "px", "left": "0px" });
    ...
    if ($("th", g.hDiv).length)
      {
        ...
        $(g.nBtn).addClass("nBtn").html("<div></div>").attr("title", "Hide/Show Columns").css("top", g.hDiv.offsetTop).click(function ()
        {
          $(g.nDiv).toggle();
          return true;
        });
